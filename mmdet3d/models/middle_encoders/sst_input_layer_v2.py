...
class SSTInputLayerV2(nn.Module):
    ...
    def forward(self, voxel_feats, voxel_coors, batch_size=None):
        ...
        '''
        #inputs = {'voxel_feats': voxel_feats, 'voxel_coors':voxel_coors, 'voxel_mean':voxel_mean, 'img_metas':img_metas, 'batch_size':batch_size}
        #ssst_input_layer = pkl.dumps(inputs)
