...
def single_gpu_test(model,
    ...
    with open('/mimer/NOBACKUP/groups/snic2021-7-127/marziehf/repo/proj_two/main_voxel/work_dirs/sst_zod_full_2sweeps_VS0.5_WS16_ED8_LRco2x_EP400_base/result.pkl', 'wb') as f:
