_base_ = [
    ...
    '../_base_/zod_datasets/zod_3d_2sweep_remove_close.py',
...
point_cloud_range = [-50.1, -0.1, -5, 50.1, 100.1, 3]
...
# runtime settings # epochs=288, eval_interval=12, check_point_interval=6
