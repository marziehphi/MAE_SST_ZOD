...
model = dict(
    ...
    bbox_head=dict(
        type='Anchor3DHead',
        num_classes=5, # 10 nusc
        in_channels=384,
        feat_channels=384,
        use_direction_classifier=True,
        anchor_generator=dict(
            type='AlignedAnchor3DRangeGenerator',
            ranges=[[-49.6, 0, -1.80032795, 49.6, 99.2, -1.80032795],
                    [-49.6, 0, -1.74440365, 49.6, 99.2, -1.74440365],
                    [-49.6, 0, -1.68526504, 49.6, 99.2, -1.68526504],
                    [-49.6, 0, -1.67339111, 49.6, 99.2, -1.67339111],
                    [-49.6, 0, -1.61785072, 49.6, 99.2, -1.61785072],
                    [-49.6, 0, -1.80984986, 49.6, 99.2, -1.80984986],
                    [-49.6, 0, -1.763965, 49.6, 99.2, -1.763965]],
    ...
    test_cfg=dict(
            ...
            nms_pre=1000,   # Changed from initial 1000
